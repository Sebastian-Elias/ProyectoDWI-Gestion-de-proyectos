<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('backoffice.dashboard') }}" class="brand-link">
        <span class="brand-image img-circle elevation-3"
            style="opacity: .8; margin-top: 0px; margin-left: 10px; font-size: 30px;"> <!-- Ajustado margen izquierdo -->
            <img src="{{ asset('assets/images/ipss.jpg') }}" alt="IPSS Logo"
                style="opacity: .8; width: 30px; height: auto; margin-left: 5px;"> <!-- Ajustado margen izquierdo -->
        </span>
        <span class="brand-text font-weight-light">Proyecto DWI</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                ...
                <form action="{{ route('usuario.logout') }}" method="POST" style="margin-top: 8px;">
                    @csrf
                    <button type="submit" class="btn-xs btn-danger">Cerrar Sesión</button>
                </form>
            </div>
        </div>
