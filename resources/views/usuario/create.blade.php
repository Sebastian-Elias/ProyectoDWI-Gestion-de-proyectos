...
<head>
    ...
    <title>Proyecto DWI | Registrar</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="#">
                <img src="{{ asset('assets/images/ipss.jpg') }}" alt="Logo" style="width: 100px; height: auto;"><br>
                Proyecto DWI
            </a>
        </div>
        <!-- /.login-logo -->
        ...
        <div class="text-center mt-4">
            <b>Grupo Akatsuki</b> <br>
            <strong>Copyriht &copy; 2023 ~ 2024 <a href="https://www.ipss.cl" target="_blank">IPSS</a> | </strong> Instituto Profesional San Sebastian.
        </div>
    </div>
    <!-- /.login-box -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>General</h3>
                    <p>Esta aplicación web es propiedad del Instituto Profesional Sán Sebastian.
                        Estos
                    ...
                    <p>
                        Esta aplicación web ofrece a los visitantes la posibilidad de crear proyectos. Al acceder o usar la aplicación web de nuestro servicio, usted
